        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="hal_peternak.php">Home</a></li>
        ...
        <div class="container" style="margin-top:10%;">
            <div class="row justify-content-center">
                <div class="col-lg-6 d-flex flex-column" data-aos="fade-up" data-aos-delay="200">
                    <h1 style="font-size: 40px;">Selamat Datang di Halaman Peternak</h1>
                    <h2 style="font-size: 20px;">Halaman ini hanya ditujukan untuk peternak agar bisa melihat data sekaligus mengatur harga ayam</h2>
                </div>
