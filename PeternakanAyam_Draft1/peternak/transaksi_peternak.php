...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="harga_peternak.php">Harga</a></li>
                    <li class="nav-item"><a class="nav-link" href="kandang_peternak.php">Kondisi Kandang</a></li>
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="transaksi_peternak.php">Transaksi</a></li>
    ...
    <a href="../fungsi/tambahtransaksi_peternak.php">Tambah Transaksi</a>
    <br><br>
    ...
    <tr>
        <td><?= $i; ?></td>
        <td>
            <a href="../fungsi/ubahtransaksi_peternak.php?id=<?= $row["id"]; ?>">Ubah</a> |
            <a href="../fungsi/hapustransaksi_peternak.php?id=<?= $row["id"]; ?>">Hapus</a>
        </td>
